...
const Tour = () => {
  ...
  const handleRedirect = () => {
    nevigate('/top-destination')
  }
  return (
    <>
      <Helmet><tetle>Tour</tetle></Helmet>
      <Title />
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-9">
              <div className="row">
                <div className="col-lg-12">
                  <div className="cruise_search_result_wrapper">
                    <div className="cruise_search_item">
                      <div className="row">
                        <div className="col-lg-4">
                          <div className="cruise_item_img">
                            <img src="assets/img/tour/tour-list-1.png" alt="img" />
                          </div>
                        </div>
                        <div className="col-lg-8">
                          <div className="cruise_item_inner_content">
                            <div className="cruise_content_top_wrapper">
                              <div className="cruise_content_top_left">
                                <ul>
                                  <li>
                                ...
                                <p>
                                  <i className="fas fa-map-marker-alt" /> Beijing,
                                  China
                                </p>
                              </div>
                              <div className="cruise_content_top_right">
                                <h5>4.8/5 Excellent</h5>
                                <h4>(1214 reviewes)</h4>
                              </div>
                            </div>
                            <div className="cruise_content_middel_wrapper">
                              <div className="cruise_content_middel_left">
                                <h5>Free cancellation</h5>
                                <p>Cancel your booking at any time</p>
                              </div>
                              <div className="cruise_content_middel_right">
                                <h3>
                                  $99.00 <sub>/Per person</sub>
                                </h3>
                                <p>+ $20.00 tax and vat</p>
                              </div>
                            </div>
                            <div className="cruise_content_bottom_wrapper">
                              <div className="cruise_content_bottom_left">
                                <ul>
                                  <li>Breakfast</li>
                                  <li>Free wi fi</li>
                                  <li>Transport</li>
                              ...
                              <div className="cruise_content_bottom_right">
                                <a
                  ...
                  <div className="load_more_flight">
                    <button className="btn btn_md" onClick={handleRedirect}>
